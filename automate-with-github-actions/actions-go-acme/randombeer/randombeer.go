...
func (mybeer *Randombeerrequest) GetData() {
	//this function will return a dad joke
	req, err := http.NewRequest("GET", "http://api.giphy.com/v1/gifs/random?tag=beer&api_key=4Z7XmRZCziCDF0q6rLwAKO7BjgGuF74u", nil)
	if err != nil {
		// handle err
	}
	...
	yourbeer := beer.Data.Images.Original.URL
	mybeer.Data = yourbeer
	mybeer.Logo = "https://media2.giphy.com/media/3o6gbbuLW76jkt8vIc/source.gif"
	mybeer.Svc = "Beer Giphy"
